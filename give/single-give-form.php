...
while ( have_posts() ) :
    ...
    $form_style = wellco_get_rwmb_group( 'wellco_' . "give_form_details_page", 'form_style', $current_page_id );

    if( wellco_metabox_opt_val_is_empty( $form_style ) ) {
        $form_style = wellco_get_redux_option( 'give-form-details-page-style', 'form-style1' );
    }
