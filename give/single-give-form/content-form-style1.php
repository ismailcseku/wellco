...
?>
	...
	<div id="give-form-<?php the_ID(); ?>-content" <?php post_class('tm-give-single-form-style1'); ?>>
		...
		<div class="tm-give-single-wrapper">
				...
				<div class="left-thumb">
					<div class="tm-give-single-thumb">
						...
						if ( has_post_thumbnail() ) {
							...
							// Placeholder Image
							echo apply_filters( 'single_give_form_image_html', sprintf( '<img src="%s" alt="%s" />', give_get_placeholder_img_src(), esc_attr__( 'Placeholder', 'wellco' ) ), $post->ID );
			...
			<div class="tm-give-single-progress-goal">
				<?php
					...
					//mascot_core_wellco_elementor_goal_progress( $post->ID, $args );
			...
			<div class="tm-give-single-donor-wall">
				<h5 class="title-recent-donations"><?php esc_html_e( 'Recent Donations', 'wellco' ); ?></h5>
				<?php
