...
<div class="give-goal-progress">
	<?php if ( ! empty( $show_bar ) ) : ?>
		<div class="tm-sc tm-sc-progress-bar" data-percent="<?php echo esc_attr( $progress_bar_value );?>" data-unit-right="%">
			<div class="progress-holder">
				<div class="progress-content"><?php echo esc_html( $progress_bar_value );?>%</div>
	   ...
	   <div class="raised">
			...
			if ( 'amount' === $goal_format ) :
				...
				echo sprintf(
					...
					wp_kses( 
						__( '<span class="income" data-amounts="%1$s">%2$s</span> of <span class="goal-text" data-amounts="%3$s">%4$s</span> raised', 'wellco' ), 
						array ( 
							'span' => array ( 
								'class' => array(),
								'data-amounts' => array(),
				...
				<!-- <ul class="donation-info">
					<li class="goal"><span class="label"><?php esc_html_e( 'Goal', 'wellco' ); ?></span><span class="value"><?php echo esc_html( $formatted_goal ); ?></span></li>
					<li class="raised"><span class="label"><?php esc_html_e( 'Raised', 'wellco' ); ?></span><span class="value"><?php echo esc_html( $formatted_income ); ?></span></li>
				</ul> -->
			<?php
		  ...
		  elseif ( 'percentage' === $goal_format ) :
				...
				echo sprintf( /* translators: %s: percentage of the amount raised compared to the goal target */
					wp_kses( 
						__( '<span class="give-percentage">%s%%</span> funded', 'wellco' ),
						array ( 
							'span' => array ( 
								'class' => array(),
							) 
