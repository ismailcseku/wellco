 ...
 */
require_once WELLCO_FRAMEWORK_DIR . '/tgm/class-tgm-plugin-activation.php';
...
function wellco_register_required_plugins() {
	$plugins_path = WELLCO_FRAMEWORK_DIR . '/tgm/plugins';
	...
	$plugins = array(
		...
		array(
			'name'         	=> 'Mascot Core - Wellco',
			'slug'         	=> 'mascot-core-wellco',
			'source'       	=> $server_path . 'mascot-core-elementor/mascot-core-wellco.zip',
			'required'     	=> true,
			'version'      	=> '1.0'
		),
		array(
		...
		array(
			'name'			=> 'The Events Calendar (Tribe)',
	 ...
	 */
	$config = array(
		'id'           => 'wellco',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		'message'      => '<div class="notice notice-info is-dismissible mt-20">
			...
			<p><strong>Note from Author ' . WELLCO_AUTHOR . ':</strong> To ensure the latest version of <em>theme required</em> plugins, you must have the latest version of <strong>' . $theme_name . '</strong></p>
