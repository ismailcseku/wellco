				...
				<div class="row">
					<div class="col-md-7">
						<div class="page-404-main-content">
							...
							<?php do_action( 'wellco_page_404_content_start' ); ?>
							...
							<?php
								if( $show_back_to_home_button ) {
									wellco_get_blocks_template_part( 'back-to-home-button', null, '404/tpl', $params );
								}
							?>

							<?php do_action( 'wellco_page_404_content_end' ); ?>
					...
					<div class="col-md-5">
						<?php
							if( $show_search_box ) {
								wellco_get_blocks_template_part( 'search-box', null, '404/tpl', $params );
							}
						?>
						<?php
							if( $show_helpful_links ) {
								wellco_get_blocks_template_part( 'helpful-links', null, '404/tpl', $params );
							}
						?>
					</div>
				</div>
				<div class="row <?php echo esc_attr( $text_align );?> mt-30">
					...
					<?php
						if( $show_social_links ) {
							wellco_get_blocks_template_part( 'social-links', null, '404/tpl', $params );
						}
					?>
					</div>
				</div>
