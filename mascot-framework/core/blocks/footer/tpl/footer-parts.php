	...
	<?php
	/**
	* wellco_before_footer hook.
	*
	*/
	do_action( 'wellco_before_footer' );
	?>
	<footer id="footer" class="footer <?php echo esc_attr( $footer_classes );?>">
	<?php
		/**
		* wellco_footer_start hook.
		*
		*/
		do_action( 'wellco_footer_start' );
	?>
		<div class="footer-widget-area">
			<div class="container">
				<?php if ( isset($footer_widget_area) && !empty($footer_widget_area) && mascot_core_wellco_plugin_installed() ) { ?>
				<div class="row">
					<div class="col-md-12">
	...
	<?php
		/**
		* wellco_footer_end hook.
		*
		*/
		do_action( 'wellco_footer_end' );
	?>
	</footer>
	<?php
	/**
	* wellco_after_footer hook.
	*
	*/
	do_action( 'wellco_after_footer' );
	?>