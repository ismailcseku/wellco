<?php wellco_enqueue_script_lightgallery(); ?>
<?php wellco_enqueue_script_owl_carousel(); ?>
<?php $gallery_images = wellco_get_rwmb_group_advanced( 'wellco_' . "blog_mb_pf_gallery_settings",  "gallery_images", null, false, 'all', 'large' );?>
