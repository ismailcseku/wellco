					...
					<div class="row">
						<div class="col">
							...
							<div class="row header-nav-col-row">
								...
								<div class="col-sm-auto pl--0 pr--0 align-self-center">
								...
								<div class="col-sm-auto <?php echo (is_rtl()) ? esc_attr( 'me-xl-auto' ) : esc_attr( 'ms-xl-auto' );?> align-self-center pe-xl-4">
					...
					<div class="row">
						<div class="col">
							...
							<div class="row header-nav-col-row">
								...
								<div class="col-sm-auto pl--0 pr--0 align-self-center">
									<nav id="top-primary-nav-sticky" class="menuzord-primary-nav menuzord <?php echo esc_attr( $navigation_color_scheme );?> p-0" data-effect="<?php echo esc_attr( $navigation_primary_effect );?>" data-animation="<?php echo esc_attr( $navigation_css3_animation );?>" data-align="left">
										<?php
											/**
											* wellco_header_primary_nav hook.
											*
